...
until confirm_email == "y"
    ...
    print "Is #{email} your email address (Y or N): "
    confirm_email = gets.chomp.downcase
    while confirm_email != "y" && confirm_email != "n"
        puts "Only Y or N are acceptable inputs. Try again."
        print "Is #{email} your email address (Y or N): "
        confirm_email = gets.chomp.downcase
    end
end
